...
public class JiraFileRules implements FilenameFilter
{
     ...
     */
    public JiraFileRules(Hashtable excludesHash)
    {
     ...
     */
    public JiraFileRules(String excludesStr)
    {
